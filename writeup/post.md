...
The 95% bootstrap CIs are tight enough that the NSA and FA-3 intervals never overlap at any sequence length, so the per-seq-len verdict is unambiguous at every point. There is no "tie" regime at this batch shape:
